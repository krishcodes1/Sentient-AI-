 ...
 * available yet. Read-only viewers get a disabled switch on every row
 * instead of the controls being hidden, so the list's shape does not shift
 * between an owner and everyone else.
 */
